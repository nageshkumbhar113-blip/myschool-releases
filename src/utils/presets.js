...
export const PRESETS = {
  ...
  admission: {
    ...
    fields: [
      ...
      { key: 'fatherName',     label: 'Father Name',     type: 'text',     x: 5,  y: 24, w: 90, h: 4,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'text',     required: false },
      { key: 'motherName',     label: 'Mother Name',     type: 'text',     x: 5,  y: 30, w: 90, h: 4,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'text',     required: false },
      { key: 'dateOfBirth',    label: 'Date of Birth',   type: 'date',     x: 5,  y: 36, w: 44, h: 4,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'date',     required: true  },
      { key: 'class',          label: 'Class',           type: 'text',     x: 51, y: 36, w: 44, h: 4,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'text',     required: false },
      { key: 'medium',         label: 'Medium',          type: 'text',     x: 5,  y: 42, w: 44, h: 4,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'text',     required: false },
      { key: 'address',        label: 'Address',         type: 'textarea', x: 5,  y: 48, w: 90, h: 8,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'textarea', required: false },
      { key: 'mobileNumber',   label: 'Mobile Number',   type: 'text',     x: 5,  y: 58, w: 44, h: 4,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'text',     required: false },
      { key: 'previousSchool', label: 'Previous School', type: 'text',     x: 51, y: 58, w: 44, h: 4,  fontSize: 12, fontWeight: 'normal', fieldSource: 'student',  inputType: 'text',     required: false },
...
export const PRESET_LIST = [
  ...
  { type: 'receipt',   label: 'Fee Receipt',           description: 'Fee receipt with payment and balance info' },
